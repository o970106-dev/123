...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const updateTelemetry = () => {
        ...
        if (heartbeatEl) {
            ...
            heartbeatEl.classList.add('bg-info');
            heartbeatEl.classList.remove('bg-danger');
            setTimeout(() => {
        ...
        rpc("/pms/staps_ping", {}).then((res) => {
            ...
            if (coordEl && res && res.coordinate) {
             ...
             if (heartbeatEl) {
                 heartbeatEl.classList.remove('bg-info');
                 heartbeatEl.classList.add('bg-danger');
             }
        });
    };
