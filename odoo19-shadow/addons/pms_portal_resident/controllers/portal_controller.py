...
class PmsPortal(http.Controller):
    ...
    def pms_dashboard(self, **kw):
        ...
        # Pre-calculate data for high-performance dashboard rendering
        # This avoids redundant database queries within the XML template
        ...
        values = {
            ...
            'eco_efficiency_score': eco_score,
