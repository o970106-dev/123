...
class PmsPortal(http.Controller):
    ...
    def claim_reward(self):
        # Highest Degree 1-hour rate limit check
        ...
        if last_reward:
            return {'status': 'error', 'message': 'Sustainability rewards are capped at once per hour to ensure balanced ecosystem growth.'}
