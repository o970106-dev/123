...
class GoogleHomeDevice(models.Model):
    ...
    def _execute_google_home_command(self, command, params):
        ...
        if command == 'action.devices.commands.OnOff':
            ...
            # Logic for activating a scene
            # In a real scenario, this would trigger multiple device actions
    ...
    def action_energy_saving_mode(self):
        ...
        """
        self.ensure_one()
        _logger.info("Triggering energy saving mode for device: %s", self.name)
