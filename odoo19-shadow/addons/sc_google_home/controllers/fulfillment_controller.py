...
class GoogleHomeFulfillment(http.Controller):
    ...
    def auth(self, **kwargs):
        ...
        if 'google.com' not in redirect_uri and 'googleusercontent.com' not in redirect_uri:
    ...
    def _handle_sync(self, user):
        ...
        # Optimization: Obfuscate agentUserId using MetricTensorCryptoEngine
        return {
        ...
        for gid in device_ids:
            ...
            if dev:
                ...
                if dev.device_type == 'action.devices.types.LOCK':
                    ...
                    status['currentTemperatureAmbient'] = dev.temperature
                    status['currentHumidityAmbient'] = dev.humidity
