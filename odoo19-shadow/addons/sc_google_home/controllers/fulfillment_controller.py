...
class GoogleHomeFulfillment(http.Controller):
    ...
    def token(self, **kwargs):
        ...
        # For POC/Demo purposes, we find a resident and return their actual token.
        # This ensures the fulfillment endpoint correctly identifies the user.
    ...
    def _handle_sync(self, user):
        ...
        device_list = []
        for dev in devices:
            # Construct name object with professional metadata
            ...
            device_list.append({
                ...
                'customData': {
                    'pms_id': dev.id,
                    'eco_scoring_active': True,
                    'optimization_level': 'Highest Degree'
                },
