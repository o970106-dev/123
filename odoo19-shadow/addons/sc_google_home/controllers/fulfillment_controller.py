            ...
            for execution in command.get('execution', []):
                ...
                for gid in device_ids:
                    ...
                    if dev:
                        if action == 'action.devices.commands.OnOff':
                        ...
                        elif action == 'action.devices.commands.ThermostatMode':
                            ...
                            # Logic for scene activation (e.g., reward)
                            if dev.eco_mode:
                                user.action_reward_sustainability(amount=2.0, reason=f"Scene {dev.name} Activated")
