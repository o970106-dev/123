...
class ResUsers(models.Model):
    ...
    def _compute_eco_score(self):
        """
        Compute Highest Degree Eco-Efficiency Score (V3 Weighted Algorithm) with Batch Processing:
        - 40% Device Variety (Smart Home adoption) -> Max 40 pts (10 pts per unique type)
        - 30% Happiness Coins (Sustainability Rewards) -> Max 30 pts (0.6 pts per coin)
        - 30% Eco-Mode Utilization (Active device management) -> Max 30 pts
        """
