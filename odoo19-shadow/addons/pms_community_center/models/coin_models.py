...
class ResUsers(models.Model):
    ...
    required_skill_id = fields.Many2one('pms.skill', string='Primary Skill Target')
    ...
    def _compute_eco_score(self):
        ...
        for user in self:
            ...
            # Bonus for Volunteering (Highest Degree exclusive)
            volunteer_bonus = 5 if user.x_is_volunteer else 0

            user.eco_efficiency_score = int(min(100, coin_points + eco_points + variety_points + volunteer_bonus))
    ...
    def get_obfuscated_id(self):
        """Returns secure obfuscated ID for public-facing templates."""
