...
class PmsSkill(models.Model):
    _name = 'pms.skill'
    _description = 'Resident Skills for Volunteering'
...
class ResUsers(models.Model):
    ...
    required_skill_id = fields.Many2one('pms.skill', string='Required Skill for Current Task')
