...
def main():
    ...
    if os.path.exists(pms_model_path):
        with open(pms_model_path, 'r') as f:
            ...
            print(f"  - Google SENSOR Support  : {'ACTIVE' if has_sensor else 'MISSING'}")
    else:
    ...
    # 4. Eco-Efficiency & Community Ecosystem
    print("\n[4] Sustainability & Community Framework Audit:")
    ...
    if os.path.exists(coin_path):
        with open(coin_path, 'r') as f:
            ...
            print(f"  - Volunteer Framework   : {'ENABLED' if has_volunteer else 'MISSING'}")
            print(f"  - Skill-Mapping System  : {'READY' if has_skill else 'MISSING'}")
    else:
