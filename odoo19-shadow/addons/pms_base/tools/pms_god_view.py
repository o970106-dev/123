...
def main():
    ...
    if os.path.exists(ff_path):
        with open(ff_path, 'r') as f:
            ...
            has_agent_obf = "agentUserId': MetricTensorCryptoEngine.encode(user.id)" in content
            ...
            print(f"  - agentUserId Obf       : {'ENABLED' if has_agent_obf else 'DISABLED'}")
    else:
    ...
    if os.path.exists(coin_path):
        with open(coin_path, 'r') as f:
            ...
            print(f"  - Volunteering Framework: {'ACTIVE' if has_volunteer else 'MISSING'}")
    else:
    ...
    if os.path.exists(xml_path):
        with open(xml_path, 'r') as f:
            ...
            has_volunteer_ui = "Community Volunteering" in content
            ...
            print(f"  - Volunteering UI      : {'VISIBLE' if has_volunteer_ui else 'HIDDEN'}")
    else:
