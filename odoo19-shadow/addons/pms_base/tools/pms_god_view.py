...
def main():
    ...
    if os.path.exists(pms_model_path):
        with open(pms_model_path, 'r') as f:
            ...
            print(f"  - Sensor Trait Support   : {'ACTIVE' if has_sensor else 'MISSING'}")
    else:
    ...
    if os.path.exists(ff_path):
        with open(ff_path, 'r') as f:
            ...
            is_obfuscated = "MetricTensorCryptoEngine.encode(user.id)" in content
            ...
            print(f"  - User ID Obfuscation   : {'SUPREME' if is_obfuscated else 'STANDARD'}")
    else:
        print("  - Fulfillment controller not found!")

    # 4. Eco-Efficiency Ecosystem & Volunteering
    print("\n[4] Sustainability & Volunteering Audit:")
    ...
    if os.path.exists(coin_path):
        with open(coin_path, 'r') as f:
            ...
            has_volunteer = "x_is_volunteer" in content and "pms.skill" in content
    ...
    if os.path.exists(xml_path):
        with open(xml_path, 'r') as f:
            ...
            has_tensor = "Metric Tensor: <span class=\"text-warning\">ACTIVE</span>" in content
            ...
            print(f"  - Metric Tensor UI     : {'ACTIVE' if has_tensor else 'MISSING'}")
    else:
