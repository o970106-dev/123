...
def main():
    ...
    if os.path.exists(ff_path):
        with open(ff_path, 'r') as f:
            ...
            has_query_sec = "resident_id', '=', user.id" in content
            has_obfuscated_agent = "MetricTensorCryptoEngine.encode(user.id)" in content
            ...
            print(f"  - Fulfillment Security  : {'SUPREME' if has_query_sec and has_obfuscated_agent else 'STANDARD'}")
    else:
        print("  - Fulfillment controller not found!")

    # 4. Eco-Efficiency & Volunteer Ecosystem
    print("\n[4] Sustainability & Volunteer Ecosystem Audit:")
    ...
    if os.path.exists(coin_path):
        with open(coin_path, 'r') as f:
            ...
            print(f"  - Volunteer Framework   : {'ACTIVE' if has_volunteer and has_skills else 'MISSING'}")
    else:
