...
def main():
    ...
    print("\n[4] Sustainability & Community Audit:")
    ...
    if os.path.exists(coin_path):
        with open(coin_path, 'r') as f:
            ...
            print(f"  - Volunteer Framework   : {'ACTIVE' if has_volunteer else 'MISSING'}")
            print(f"  - Skill Matrix Integration: {'READY' if has_skills else 'MISSING'}")
    else:
