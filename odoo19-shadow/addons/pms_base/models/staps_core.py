        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                if persist:
                    new_cr = None
                    try:
                        # Attempt to find registry from args or http request
                        registry = None
                        ...
                        if registry:
                            # Use a separate cursor to ensure telemetry persists even if main transaction rolls back
                            new_cr = registry.cursor()
                            env = api.Environment(new_cr, 1, {}) # System user
