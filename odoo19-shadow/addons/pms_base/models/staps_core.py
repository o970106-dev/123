                ...
                if persist:
                    try:
                        ...
                        if env:
                            ...
                            resident_id = False
                            if args and isinstance(args[0], type(env['res.users'])):
                            ...
                            # OPTIMIZED: Use standard environment for persistence
                            # In high-performance systems, this should be offloaded to a queue (e.g. Odoo Job Queue)
                            # or external log aggregator to avoid DB connection exhaustion.
