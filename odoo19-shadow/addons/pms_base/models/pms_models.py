...
class PmsDevice(models.Model):
    ...
    # Metadata for Professional Google Home Fulfillment
    manufacturer = fields.Char(string='Manufacturer', default='Supreme PMS Corp')
    model_number = fields.Char(string='Model Number', default='SPMS-V2-ULT')
    hw_version = fields.Char(string='Hardware Version', default='2.1.0')
    sw_version = fields.Char(string='Software Version', default='STAPS-2.0.4')
...
class PmsTelemetry(models.Model):
    ...
    resident_id = fields.Many2one('res.users', string='Associated Resident')
