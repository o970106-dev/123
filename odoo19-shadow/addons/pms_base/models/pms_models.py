...
class PmsDevice(models.Model):
    ...
    def get_google_traits(self):
        """Return list of standard Google Home traits based on device type."""
        ...
        elif self.device_type == 'action.devices.types.SCENE':
            return ['action.devices.traits.Scene']

        # Universal telemetry traits
    ...
    def get_google_attributes(self):
        """Return dict of Google Home attributes."""
        attrs = {
            'sensorStates': [{
