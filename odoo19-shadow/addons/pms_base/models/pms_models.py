...
class PmsDevice(models.Model):
    ...
    manufacturer = fields.Char(string='Manufacturer', default='PMS Smart Home')
    model_number = fields.Char(string='Model Number', default='PMS-X1')
    hw_version = fields.Char(string='Hardware Version', default='1.0.0')
    sw_version = fields.Char(string='Software Version', default='2.0.0')
