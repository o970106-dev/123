...
class PmsDevice(models.Model):
    ...
    # Rich Metadata for Google Home
    manufacturer = fields.Char(string='Manufacturer', default='PMS Ultimate Corp')
    model_number = fields.Char(string='Model Number', default='PMS-X1-Supreme')
    hw_version = fields.Char(string='Hardware Version', default='v2.0')
    sw_version = fields.Char(string='Software Version', default='v3.1.4')
