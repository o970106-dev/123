...
class PmsDevice(models.Model):
    ...
    room_name = fields.Char(string='Room Name', default='Main Room')
    ...
    def get_google_traits(self):
        ...
        traits = ['action.devices.traits.OnOff', 'action.devices.traits.Brightness', 'action.devices.traits.FanSpeed', 'action.devices.traits.ColorTemperature', 'action.devices.traits.SensorState']
    ...
    def get_google_attributes(self):
        ...
        if self.device_type == 'action.devices.types.THERMOSTAT':
             attrs['availableThermostatModes'] = ['off', 'heat', 'cool', 'on']
