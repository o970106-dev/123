...
class PmsDevice(models.Model):
    ...
    # Google Home Metadata
    manufacturer = fields.Char(string='Manufacturer', default='Supreme PMS Corp')
    model_number = fields.Char(string='Model Number', default='SP-2000-X')
    hw_version = fields.Char(string='Hardware Version', default='v2.1')
    sw_version = fields.Char(string='Software Version', default='v3.5.0-supreme')
