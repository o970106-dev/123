...
class VoucherValidationWizard(models.TransientModel):
    _name = 'pms.ax2.voucher.validation.wizard'
    _description = 'AX2 Voucher Validation Wizard'

    qr_code = fields.Char(string='Scan QR Code', required=True)
    service_quality_score = fields.Float(string='AX2 Service Quality Score', default=5.0)
