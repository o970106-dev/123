from staps_core import staps_timed, STAPS_MULTIPLIER, get_absolute_coordinate
import time
...
class MockCommunitySystem:
    ...
    def create_delivery_order(self, resident_name, pickup, delivery):
        ...
        order_id = get_absolute_coordinate(f"{resident_name}-{time.time()}")[:8]
    ...
    def merchant_redeem_voucher(self, qr_code):
        ...
        coordinate = get_absolute_coordinate(qr_code)
